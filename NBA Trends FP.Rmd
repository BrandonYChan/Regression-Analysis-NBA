...
# Objective  
Many older NBA fans like to make claims about how the league was different back in their day. They often criticize today's game for the high frequency of threes attempted. The aim of this analysis is to see how the game has changed, and why these changes have taken place.
# Data Description 
...
----------------------------------------------------------------------------------------------------------------------------------------
## 3 Point Attempts Versus Defensive Stats
Based on the stats Regress defensive stats against 3 point attempts to see if better defense leads to more 3 point attempts
