...
$$ \widehat{3PA} = -453.6132 + 4.01TRB + 1.86STL + 4.93TOV + 2.62PTS -2.94ORB\% $$
...
### Analyzing the Model on the Train Set 
...
```{r}
SS_reg = 921.71+1762.81+287.96+100.20+407.91 
SS_res = 12.31
...
### Analyzing the Model Predictions on the Test Set  
...
----------------------------------------------------------------------------------------------------------------------------------------
## Is defense impacting the number of 3 point shots attempted?
